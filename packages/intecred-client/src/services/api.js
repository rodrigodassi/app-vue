...
// ------------------------------- HOMOLOGACAO -------------------------------
//
// const url = 'https://intecred.azurewebsites.net/api'.toString();
// const AllowOrigin = 'https://intecredfront.z15.web.core.windows.net';
// const AllowMethods = 'GET,HEAD,OPTIONS,POST,PUT';
//
// --------------------------------- PRODUCAO --------------------------------
//
// const url = 'https://prod-intecred.azurewebsites.net/api'.toString();
