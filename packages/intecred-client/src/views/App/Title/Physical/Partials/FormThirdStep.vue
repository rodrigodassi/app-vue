  ...
  <div class="form-data">
    ...
    <div class="form-data__item--size-bottom">
      <div class="form-data__radio">
        ...
        <el-radio-group class="form-data__radio__options" v-model="depositarioEmitente">
      ...
      <div class="form-data__item--size-bottom">
        <div class="form-data__radio">
          ...
          <el-radio-group v-model="tipoPessoaDepositario">
            <el-radio @change="CHANGE_PERSON_TYPE('pf')" label="pf">PF</el-radio>
            <el-radio @change="CHANGE_PERSON_TYPE('pj')" label="pj">PJ</el-radio>
          </el-radio-group>
        </div>
      </div>
      <div class="form-data__item--size-bottom">
