  ...
  <div class="form-data">
    ...
    <div class="form-data__item--size-bottom">
      <IntInput
        ...
        isDate
        :isBetweenDate="depositarioEmitente === 'true'"
      />
    </div>
    <!-- TODO fix resize -->
    <div class="form-data__item--size-bottom">
      <div class="form-data__radio">
        ...
        <el-radio-group v-model="depositarioEmitente">
          <el-radio @select="CHANGE_DEPOSITARY(true)" label="true">Sim</el-radio>
          <el-radio @select="CHANGE_DEPOSITARY(false)" label="false">Não</el-radio>
        </el-radio-group>
      </div>
    </div>
    <div
      v-show="depositarioEmitente === 'false'"
...
export default {
  ...
  computed: {
    ...
    depositarioEmitente: {
      get() {
        return this.title.depositarioEmitente || 'true';
      },
      set(value) {
        this.UPDATE_PARTIALS_FORM({
    ...
    tipoPessoaDepositario: {
      get() {
        return this.title.tipoPessoaDepositario || 'pf';
      },
      set(value) {
        this.UPDATE_PARTIALS_FORM({
          key: 'tipoPessoaDepositario',
          value,
        });
      },
    },
