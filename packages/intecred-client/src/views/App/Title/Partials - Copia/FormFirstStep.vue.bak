  ...
  <div>
    ...
    <div class="form-data__item--size-bottom">
      <div class="form-data__radio">
        ...
        <el-radio-group v-model="proprioEmitente">
          <el-radio
            @change="CLEAR_ISSUER" label="own">Próprio Cliente</el-radio>
          <el-radio
            @change="ADD_NEW_ISSUER" label="new">Novo Emitente</el-radio>
        </el-radio-group>
      </div>
    </div>
    <div
    ...
    <div>
      <button
        class="form-data__add-issuer"
        v-if="proprioEmitente === 'new'" @click.stop.prevent="ADD_NEW_ISSUER">
        <IconPlus/>
        Adicionar emitente
      </button>
    </div>
...
export default {
  ...
  computed: {
    ...
    proprioEmitente: {
      get() {
        return this.title.proprioEmitente || 'own';
      },
      set(value) {
        this.UPDATE_PARTIALS_FORM({
          key: 'proprioEmitente',
